...
const Header: React.FC = () => {
  return (
    <div className="w-full flex justify-between py-3 pr-2 items-center bg-first">
      <div>
        <div className="flex search text-black items-center p-1 w-48 sm:w-60 md:w-72 gap-2">
          ...
          <IoIosSearch size={25} className="cursor-pointer fill-second" />
        </div>
      </div>
      <div className="flex items-center gap-2 md:gap-5">
        <div className="flex items-center gap-2 cursor-pointer">
          <p className="hidden text-sm md:block text-second font-RobotoBold tracking-tighter">Erfan Sahafi</p>
          <Image
            src="/images/prof.jpg"
            width={30}
            height={30}
